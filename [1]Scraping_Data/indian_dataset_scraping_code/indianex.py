...
def get_contentListShow(url):
	...
	while(index!=-1 and len(arrbit) < 1000):
		...
		zarticle = zsoup.find("div",class_="container")
		t = ""
		p = ""
		try:
			t = cleanhtml(tokenize((str)(zarticle.find('h1'))))
		...
		if(c!='none' and c!="" and z not in arrlink and z.find("http")!=-1 and z.find("http://indianexpress.com/section/india/politics/page/")==-1):		
			arrtitle.append(t)
			arrcontent.append(c)
			arrlink.append(z)
			print z
...
def main():
	url = "http://indianexpress.com/section/india/politics/page/"
	num = 1
